...
Dockerfile (and nix module) to build a container image to run [unbound dns](https://www.nlnetlabs.nl/projects/unbound/about/) using [redis](https://redis.io/) as a cache database. Also includes a [prometheus](https://prometheus.io/) exporter and [promtail/loki](https://grafana.com/docs/loki/latest/) log scraper written by [ar51an](https://github.com/ar51an).
